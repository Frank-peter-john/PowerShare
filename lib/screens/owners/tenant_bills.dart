...
class TenantsBillsScreen extends StatelessWidget {
  const TenantsBillsScreen({super.key});
                ...
                return Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        SmallText(
                          text: 'This are bills of the Tenants',
                        ),
                        SizedBox(height: Dimensions.height10),
                        Expanded(
                          child: SizedBox(
                                                    ...
                                                    builder:
                                                      ...
                                                      if (!snapshot.hasData ||
                                                        ...
                                                        return const Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'This tenant has no bills yet.',
                                                            ),
                                                            SizedBox(height: 8),
                                                            Text(
                                                              'They have not added any appliance in the system.',
                                                            )
                                                          ],
                                                        );
                                                      }
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SmallText(
                        text:
                            'Your tenants will bills will appear here. No Tenants have paid yet.',
